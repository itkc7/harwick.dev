      ...
      <form className="flex flex-col lg:space-y-12 space-y-8">
        <input
          ...
          className="md:w-[500px] w-[330px] h-13
              pl-3 text-lg outline-0 border border-red-500 dark:border-yellow-500 placeholder:gray-600 dark:placeholder:yellow-500/50
              transition-colors duration-500"
        />
        <textarea
          placeholder="Message"
          className="md:w-[500px] w-[330px] h-13 pl-3 text-lg outline-0 border border-red-500 dark:border-yellow-500 placeholder:gray-600 dark:placeholder:yellow-500/50
        ...
        <input
          ...
          className="md:w-[500px] w-[330px] h-13
              pl-3 text-lg outline-0 bg-red-500  dark:bg-yellow-500 text-white dark:text-gray-900 uppercase font-extrabold
